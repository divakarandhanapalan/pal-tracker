...
public class TimeEntryControllerTest {
    ...
    public void testCreate() {
        long projectId = 123L;
        long userId = 456L;
        TimeEntry timeEntryToCreate = new TimeEntry(projectId, userId, LocalDate.parse("2019-08-21"), 8);

        long timeEntryId = 1L;
        TimeEntry expectedResult = new TimeEntry(timeEntryId, projectId, userId, LocalDate.parse("2019-08-21"), 8);
    ...
    public void testList() {
        List<TimeEntry> expected = asList(
                ...
                new TimeEntry(2L, 789L, 321L, LocalDate.parse("2019-08-21"), 4)
        );
    ...
    public void testUpdate() {
        ...
        long projectId = 987L;
        long userId = 654L;
        TimeEntry expected = new TimeEntry(timeEntryId, projectId, userId, LocalDate.parse("2019-08-21"), 4);
        doReturn(expected)
                .when(timeEntryRepository)
