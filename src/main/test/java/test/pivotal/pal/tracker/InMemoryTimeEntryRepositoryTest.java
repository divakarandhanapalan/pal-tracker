...
public void create() throws Exception {
    ...
    long projectId = 12L;
    long userId = 45L;
    TimeEntry createdTimeEntry = repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2019-08-21"), 8));

    long timeEntryId = 1L;
    TimeEntry expected = new TimeEntry(timeEntryId, projectId, userId, LocalDate.parse("2019-08-21"), 8);
    ...
    public void find() throws Exception {
        ...
        long projectId = 12L;
        long userId = 45L;
        repo.create(new TimeEntry(projectId, userId, LocalDate.parse("2019-08-21"), 8));
    ...
    public void list() throws Exception {
        InMemoryTimeEntryRepository repo = new InMemoryTimeEntryRepository();
        repo.create(new TimeEntry(123L, 456L, LocalDate.parse("2019-08-21"), 8));
        repo.create(new TimeEntry(789L, 654L, LocalDate.parse("2019-08-21"), 4));

        List<TimeEntry> expected = asList(
                new TimeEntry(1L, 123L, 456L, LocalDate.parse("2019-08-21"), 8),
                new TimeEntry(2L, 789L, 654L, LocalDate.parse("2019-08-21"), 4)
        );
